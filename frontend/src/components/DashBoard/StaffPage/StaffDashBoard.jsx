...
//   // const { leaveForms  ,fetchLeaveForms} = StaffStore();
  
//   // useEffect(() => {
//   //   fetchLeaveForms();
//   // }, []);
//   // leaveRequests = leaveForms||[];
//   // 
//   const leaveRequests = [
...
//         <div
//           className="w-[90%] shadow-md rounded-2xl p-3 mb-4 bg-orange-200 backdrop-blur-md border border-white/30 relative cursor-pointer"
//           onClick={() => navigate('/staff/leaverequests', { state: { leaveRequests } })}
//         >
