  ...
  return (
    <>
      <div className="sm:pt-20 overflow-hidden font-sans text-sm flex flex-col items-center justify-center">
        <div className="w-full max-w-xs md:max-w-3xl bg-white rounded-2xl shadow-xl shadow-black/15 p-8 pt-0 pb-4 px-2 md:px-12 text-center font-sans text-sm">
        ...
        <button onClick={handleLogout} className="mt-4 flex items-center gap-2 px-4 py-2 border-2 border-orange-300 text-orange-500 bg-white rounded-lg transition-colors duration-200 text-base font-semibold w-full max-w-2xs justify-center cursor-pointer hover:bg-orange-300/80 hover:text-white">
