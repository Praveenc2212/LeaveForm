      ...
      <div className="w-full max-w-screen-md flex flex-col items-center gap-6 mt-0 pt-4 sm:pt-20">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 w-full">
          ...
          >
            ...
            />
            <span className="text-sm text-black">Add Student</span>
          </button>
          ...
          >
            ...
            />
            <span className="text-sm text-black">Update Student</span>
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 w-full">
          ...
          >
            ...
            />
            <span className="text-sm text-black">Delete Student</span>
          </button>
        </div>
      </div>
    </div>
