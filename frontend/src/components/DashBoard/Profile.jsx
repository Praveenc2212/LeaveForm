  ...
  return (
    <>
      ...
      <div className="min-h-screen mt-7 h-[90vh] overflow-hidden bg-orange-50/30 font-sans text-sm flex flex-col items-center justify-center p-1">
        ...
        {/* Logout Button */}
        <button className="mt-4 flex items-center gap-2 px-4 py-2 border-2 border-orange-300 text-orange-500 bg-white rounded-lg transition-colors duration-200 text-base font-semibold w-full max-w-xs justify-center cursor-pointer hover:bg-orange-300 hover:text-white">
