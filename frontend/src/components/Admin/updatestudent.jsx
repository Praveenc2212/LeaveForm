...
function UpdateStudent() {
  ...
  const handleEditClick = (index) => {
    ...
    setEditedRow({ ...filteredRows[index] }); // use filteredRows for correct editing
  };

  const handleSaveClick = (index) => {
    const originalIndex = rows.findIndex(row => row.roll === filteredRows[index].roll);
                  ...
                  {editingIndex === index ? (
                    <>
                      ...
                      <td className="border px-2 py-1">
                        <input
                          type="text"
                          value={editedRow.roll}
                          onChange={(e) => handleInputChange(e, "roll")}
                          className="border p-1 w-full"
                        />
                      </td>
                      <td className="border px-2 py-1">
